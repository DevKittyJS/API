function loadIcons() {
  ...
  if (!supportsMask) {
    console.error("DevKitty icons not supported in this browser.");
  ...
  icons.forEach((el) => {
    ...
    const url = `https://raw.githubusercontent.com/DevKittyJS/API/main/icons/${folderName}/${iconName}.svg?v=${version}`;
...
`;
    ...
    console.log(`Icon style for "${cacheKey}" added`);
  });
}
